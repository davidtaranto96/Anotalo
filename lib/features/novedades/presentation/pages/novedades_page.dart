...
const List<_Release> _releases = [
  ...
  _Release(
    ...
    items: [
      ...
      _ChangelogItem(_mj, Icons.lightbulb_outline_rounded,
          'Iconos minimalistas en Inbox: reemplacé los emoji 💡📋✓🎯 por outlines Material — más limpio en dark mode y más profesional.'),
      _ChangelogItem(_mj, Icons.timer_rounded,
          'Enfoque: saqué los emoji 🍅🔥🧠☕ de los modos del timer (chips, label inferior y bottom sheet de Configuración). El timer ring también pulido — números 56pt con tracking más cerrado, label "MM:SS" abajo, anillo 25% más grueso.'),
      _ChangelogItem(_fx, Icons.check_circle_rounded,
          'Inbox: el check de selección estaba arriba-izquierda y tapaba el texto cuando seleccionabas una nota. Movido a arriba-derecha (más chico) y se oculta el pin para no chocar.'),
    ],
  ),
  _Release(
    version: '1.19.0',
